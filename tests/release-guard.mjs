...
for (const file of ['index.html','catalogue.html','about.html','faq.html','contact.html','universe.html','catalogue-body-glow.json','script.js','features.js','localization.js','localization-ro.js','multilingual.js','multilingual-pages.js','faq-multilingual-extra.js','catalogue-language.js','catalogue-page-multilingual.js','catalogue-multilingual.js','catalogue-extra-translations.js','ritual-experience.js']) mustExist(file);
...
const faq = mustContain('faq.html', ['Frequently Asked Questions','faq-multilingual-extra.js']);
...
const faqExtra = read('faq-multilingual-extra.js');
for (const lang of ['fr','it','de']) if (!faqExtra.includes(`${lang}:`)) throw new Error(`FAQ answer translation layer missing ${lang}`);
for (const term of ['Yes. We begin creating after your order is placed','The making time shown beside a product begins','Many creations can be made more personal']) if (!faqExtra.includes(term)) throw new Error(`FAQ translation coverage missing source copy: ${term}`);
...
console.log('Body Glow release guard PASS: core pages/copy, complete FAQ language wiring, five-language catalogue wiring, approved Romanian copy and observer-free catalogue protections are present.');
