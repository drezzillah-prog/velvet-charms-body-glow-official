(()=>{
  const ro={
    ...
    'Explore the Velvet Universe':'Descoperă Universul Velvet',
    'The catalogue price remains the product price. Your production window and any preferred date are reviewed against the current production queue. Shipping is calculated separately according to destination, parcel size and weight.':'Prețul din catalog rămâne prețul produsului. Intervalul de producție și orice dată preferată sunt verificate în funcție de coada de producție curentă. Transportul se calculează separat în funcție de destinație, dimensiunea și greutatea coletului.',
